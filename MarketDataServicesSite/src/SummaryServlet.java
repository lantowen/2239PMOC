...
public class SummaryServlet extends HttpServlet {
    ...
    public SummaryServlet() {
        ...
        if (isGrieg != null) {
			...
			url = "http://tlan184.srvr:8080/axis2/services/SummaryMarketDataService?wsdl";

        } else {
        	System.out.println("'grieg' environment variable NOT set. Using development settings");
        	url = "http://localhost:8080/axis2/services/SummaryMarketDataService?wsdl";
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        NodeList returnList = body.getElementsByTagName("ser:summaryMarketDataResponse");
